...
const LABEL = "com.hltm.broker";
const TARGET = `system/${LABEL}`;
const SERVICE_DIR = path.join(os.homedir(), ".local", "share", "hltm-broker-service");
...
module.exports = { createServiceManager, renderPlist, SERVICE_DIR, LABEL, healthy };
